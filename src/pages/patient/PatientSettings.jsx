...
export default function PatientSettings() {
  ...
  const [notifs, setNotifs] = useState({ email: true, sms: true, reminders: true });
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
      ...
      <Card>
        ...
        <p className="text-xs text-ink-500 mb-2">Stay updated on your care.</p>
        <div className="divide-y divide-ink-100">
          <Toggle checked={notifs.email} onChange={() => handleToggleNotif("email")} label="Email Notifications" description="Appointment confirmations and results" />
          <Toggle checked={notifs.sms} onChange={() => handleToggleNotif("sms")} label="SMS Reminders" description="Text reminders before your visit" />
          <Toggle checked={notifs.reminders} onChange={() => handleToggleNotif("reminders")} label="Medication Reminders" description="Reminders to take prescribed medicine" />
        </div>
      </Card>
      ...
      <Card className="lg:col-span-2">
        ...
        <p className="text-xs text-ink-500 mb-2">Keep your health records secure.</p>
        <div className="divide-y divide-ink-100">
          <Toggle
            checked={twoFA}
