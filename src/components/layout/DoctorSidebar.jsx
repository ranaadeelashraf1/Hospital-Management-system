...
import {
  LayoutDashboard, Users, CalendarDays, ClipboardList, UserCircle, Settings, LogOut, X,
} from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <div className="px-5 pt-4">
          <span className="inline-block px-2.5 py-1 rounded-full bg-primary-100 text-primary-700 text-[11px] font-medium tracking-wide">
            DOCTOR PORTAL
          </span>
        </div>
